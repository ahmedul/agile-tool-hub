...
description: "Write API requirements that developers understand: Endpoints, request/response formats, error handling, rate limiting, and authentication. Includes Jira template and examples."
