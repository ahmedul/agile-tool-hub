---
title: "Scrum Ceremonies: 4 Events, Order & Timeboxes"
description: "Learn the 4 Scrum ceremonies in order: Sprint Planning, Daily Scrum, Sprint Review, and Retrospective, with agendas, timeboxes, outputs, and free tools."
...
howToSteps:
  - name: "Plan the sprint"
    description: "Set a useful Sprint Goal, review team capacity, and select clear backlog items the team can realistically complete."
  - name: "Run the Daily Scrum"
    description: "Inspect progress toward the Sprint Goal, agree on the next day's plan, and surface blockers that need follow-up."
  - name: "Hold the Sprint Review"
    description: "Show the working product increment, gather stakeholder feedback, and adapt the Product Backlog based on what was learned."
  - name: "Run the Sprint Retrospective"
    description: "Inspect how the team worked, choose one or two specific improvements, and assign owners for the next sprint."
  - name: "Prepare the next cycle"
    description: "Use the improvement actions and refined backlog to make the next Sprint Planning session faster and more focused."
faqItems:
...
Use the [Sprint Planning Checklist](/tools/sprint-planning-checklist) to prepare the first event, the [Daily Standup Generator](/tools/daily-standup-generator) for daily updates, and the [Retrospective Board](/tools/retro-board) to capture improvement actions.
