---
title: "Story Points Explained: Fibonacci & Examples"
description: "Learn what Agile story points mean, how the Fibonacci scale works, story points vs hours, estimation examples, Planning Poker, and velocity."
...
For a quick starting estimate, use the [free Story Point Calculator](/tools/story-point-calculator). For a team decision, use [Planning Poker](/tools/planning-poker) so everyone votes before discussion.
