...
description: "Use this free Jira bug report template to create clear tickets with steps to reproduce, expected result, actual result, priority, and acceptance criteria."
