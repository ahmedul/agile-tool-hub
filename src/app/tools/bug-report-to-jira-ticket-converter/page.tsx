...
const faqItems = [
  ...
  { question: "Does this send my data anywhere?", answer: "No. The conversion happens entirely in your browser. Your bug notes are never sent to a server." },
  ...
  { question: "Will you add AI-powered conversion?", answer: "Yes, AI-powered generation is planned. The current version uses a structured template to ensure consistent output." },
